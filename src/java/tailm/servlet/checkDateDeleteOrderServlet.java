 ...
 * @author DELL INC
 */
@WebServlet(name = "checkDateDeleteOrderServlet", urlPatterns = {"/checkDateDeleteOrderServlet"})
public class checkDateDeleteOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("checkDateDeleteOrderServlet_SQLEx: "+ex.getMessage());
        }catch(NamingException ex){
            log("checkDateDeleteOrderServlet_NamingEx: "+ex.getMessage());
        }finally{
            out.close();
        }
    }
